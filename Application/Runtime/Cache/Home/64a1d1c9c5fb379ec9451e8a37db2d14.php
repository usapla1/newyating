...
<div id="body">
    <div id="header">
        <div class="wrapper">
            <a  href="<?php echo U('Index/index');?>" class="logo" style="margin:10px auto">
          <img src="<?php echo C('Base_Url');?>images/logo4.png" width="400" height="83" alt="招聘" />
        </a>
            <ul id="navheader" class="reset">
                <li><a href="<?php echo U('Index/index');?>">首页</a></li>
                <li class="current"><a rel="nofollow" href="<?php echo U('Work/index');?>">职位管理</a></li>
            </ul>
            <dl class="collapsible_menu">
                ...
                <dd style="display: none;">
                    <a href="<?php echo U('Work/index');?>">我发布的职位</a>
                </dd>
                <dd style="display: none;">
                    <a href="<?php echo U('Work/workchose');?>">我收到的简历</a>
                </dd>
                <dd class="btm" style="display: none;">
                    <a href="<?php echo U('Index/index');?>">我的公司主页</a>
                </dd>
                <dd class="logout" style="display: none;">
                    <a rel="nofollow" href="<?php echo U('Index/logout');?>">退出</a>
                </dd>
            </dl>
        </div>
    </div>
    ...
    <div id="container">
        <div class="sidebar">
            <a class="btn_create" href="<?php echo U('Work/create');?>">发布新职位</a>
            <dl class="company_center_aside">
                <dt>
                    职位管理
                </dt>
                <dd>
                    <a href="<?php echo U('Work/index');?>">职位列表</a>
                </dd>
                <dd>
                    <a href="<?php echo U('Seeker/index');?>">简历筛选</a>
                </dd>
                <dd>
                    <a href="<?php echo U('Mail/index');?>">面试通知</a>
                </dd>
            </dl>
        </div>
        <!-- end .sidebar -->
