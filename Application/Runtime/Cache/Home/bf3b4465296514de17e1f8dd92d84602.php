        ...
        <div id="container">
            <div id="sidebar">
                ...
                <div class="slider">
                    <ul class="slider-main">
                        <li class="slider-panel">
                            <a href="http://www.wynca.com/index.php/news/info/999" target="_blank"><img alt="季诚建董事长带队赴九江石化交流智能制造" title="季诚建董事长带队赴九江石化交流智能制造" src="<?php echo C('Base_Url');?>images/4.jpg"></a>
                        </li>
                        <li class="slider-panel">
                            <a href="http://www.wynca.com/index.php/news/info/987" target="_blank"><img alt="新安集团领导调研江苏子公司" title="新安集团领导调研江苏子公司" src="<?php echo C('Base_Url');?>images/1.jpg"></a>
                        </li>
                        <li class="slider-panel">
                            <a href="http://www.wynca.com/index.php/news/info/987" target="_blank"><img alt="董事长带队赴传化集团学习交流" title="董事长带队赴传化集团学习交流" src="<?php echo C('Base_Url');?>images/2.jpg"></a>
                        </li>
                        <li class="slider-panel">
                            <a href="http://www.wynca.com/index.php/news/info/991" target="_blank"><img alt="王伟书记参加省石化协会二届六次理事会" title="王伟书记参加省石化协会二届六次理事会" src="<?php echo C('Base_Url');?>images/3.jpg"></a>
                        </li>
                    </ul>
                ...
                <div class="mainNavs">
                    ...
                    <div class="menu_box">
                        <div class="menu_main">
                            <a class="sidebarHref" href="<?php echo U('Login/index');?>" title="个人用户登录"><h2>个人用户登录<span></span></h2></a>
                        </div>
                    </div>
                    <div class="menu_box">
                        <div class="menu_main">
                            <a class="sidebarHref" href="<?php echo U('Login/index');?>" title="企业用户登陆"><h2>企业用户登陆<span></span></h2></a>
                        </div>
                    </div>
                </div>
            </div>
