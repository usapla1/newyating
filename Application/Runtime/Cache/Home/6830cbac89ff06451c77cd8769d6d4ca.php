...
<div id="body">
    <div id="header">
        <div class="wrapper">
            <a class="logo" href="h/" style="margin: 10px auto">
            ...
            <dl class="c_section">
                ...
                <dd id="pad">
                    <ul class="user_noModify">
                        ...
                        <li>登录密码：<span><?php echo ($list["repassword"]); ?></span>    <a href="http://127.0.0.1/newfish/index.php/Home/User/uppwd/?repassword=<?php echo ($list["repassword"]); ?>" alt="修改密码">修改密码</a> </li>
                    </ul>
                </dd>
            </dl>
